...
public class PassiveAndActiveScan {
	...
	public void testPassiveScan() {
		...
		ZapUtility1.waitTillPassiveScanCompleted();
	}

	@Test
	public void testActiveScan() throws ClientApiException {
		ZapUtility1.addURLToScanTree(urlToTest);
		ZapUtility1.performActiveScan(urlToTest, contextName);
	}
