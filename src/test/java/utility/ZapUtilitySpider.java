...
public class ZapUtilitySpider {
	...
	public static Integer getContextAfterImporting(String contextName) throws ClientApiException {
	...
	public static void generateZapReport(String siteToTest, String reportName) {
		String title = "SALK MCC Security Test Report";
